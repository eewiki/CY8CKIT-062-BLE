...
#define I2C_1_ENABLE_SLAVE       (0UL != (I2C_1_MODE & CY_SCB_I2C_SLAVE))
#define I2C_1_ENABLE_MASTER      (0UL != (I2C_1_MODE & CY_SCB_I2C_MASTER))
#define I2C_1_MANUAL_SCL_CONTROL (0UL != 0UL)
...
__STATIC_INLINE uint32_t I2C_1_SetDataRate(uint32_t dataRateHz, uint32_t scbClockkHz);
__STATIC_INLINE uint32_t I2C_1_GetDataRate(uint32_t scbClockkHz);

/* Register callbacks. */
__STATIC_INLINE void I2C_1_RegisterEventCallback(scb_i2c_handle_events_t callback);
#if (I2C_1_ENABLE_SLAVE)
__STATIC_INLINE void I2C_1_RegisterAddrCallback (scb_i2c_handle_addr_t callback);
...
__STATIC_INLINE void     I2C_1_SlaveConfigReadBuf(uint8_t *rdBuf, uint32_t size);
...
__STATIC_INLINE void     I2C_1_SlaveConfigWriteBuf(uint8_t *wrBuf, uint32_t size);
...
__STATIC_INLINE cy_en_scb_i2c_status_t I2C_1_MasterRead(cy_stc_scb_i2c_master_xfer_config_t *masterXferConfig);
__STATIC_INLINE void I2C_1_MasterAbortRead(void);
__STATIC_INLINE cy_en_scb_i2c_status_t I2C_1_MasterWrite(cy_stc_scb_i2c_master_xfer_config_t *masterXferConfig);
...
__STATIC_INLINE cy_en_scb_i2c_status_t I2C_1_MasterSendStart(uint32_t address, uint32_t bitRnW, uint32_t timeoutMs);
__STATIC_INLINE cy_en_scb_i2c_status_t I2C_1_MasterSendReStart(uint32_t address, uint32_t bitRnW, uint32_t timeoutMs);
__STATIC_INLINE cy_en_scb_i2c_status_t I2C_1_MasterSendStop(uint32_t timeoutMs);
__STATIC_INLINE cy_en_scb_i2c_status_t I2C_1_MasterReadByte(uint32_t ackNack, uint8_t *byte, uint32_t timeoutMs);
__STATIC_INLINE cy_en_scb_i2c_status_t I2C_1_MasterWriteByte(uint32_t theByte, uint32_t timeoutMs);
#endif /* (I2C_1_ENABLE_MASTER) */
...
__STATIC_INLINE void I2C_1_SlaveConfigReadBuf(uint8_t *rdBuf, uint32_t size)
{
    Cy_SCB_I2C_SlaveConfigReadBuf(I2C_1_HW, rdBuf, size, &I2C_1_context);
}
...
__STATIC_INLINE void I2C_1_SlaveConfigWriteBuf(uint8_t *wrBuf, uint32_t size)
{
    Cy_SCB_I2C_SlaveConfigWriteBuf(I2C_1_HW, wrBuf, size, &I2C_1_context);
}
...
__STATIC_INLINE cy_en_scb_i2c_status_t I2C_1_MasterRead(cy_stc_scb_i2c_master_xfer_config_t *masterXferConfig)
{
    return Cy_SCB_I2C_MasterRead(I2C_1_HW, masterXferConfig, &I2C_1_context);
}
...
__STATIC_INLINE cy_en_scb_i2c_status_t I2C_1_MasterWrite(cy_stc_scb_i2c_master_xfer_config_t *masterXferConfig)
{
    return Cy_SCB_I2C_MasterWrite(I2C_1_HW, masterXferConfig, &I2C_1_context);
}
...
__STATIC_INLINE cy_en_scb_i2c_status_t I2C_1_MasterWriteByte(uint32_t theByte, uint32_t timeoutMs)
{
    return Cy_SCB_I2C_MasterWriteByte(I2C_1_HW, theByte, timeoutMs, &I2C_1_context);
}
#endif /* (I2C_1_ENABLE_MASTER) */
