...
typedef enum {
  ...
  ioss_interrupts_gpio0_IRQn        =   0,      /*!<   0 [DeepSleep] GPIO Port Interrupt #0 */
  ioss_interrupts_gpio1_IRQn        =   1,      /*!<   1 [DeepSleep] GPIO Port Interrupt #1 */
  ioss_interrupts_gpio2_IRQn        =   2,      /*!<   2 [DeepSleep] GPIO Port Interrupt #2 */
  ioss_interrupts_gpio3_IRQn        =   3,      /*!<   3 [DeepSleep] GPIO Port Interrupt #3 */
  ioss_interrupts_gpio4_IRQn        =   4,      /*!<   4 [DeepSleep] GPIO Port Interrupt #4 */
  ioss_interrupts_gpio5_IRQn        =   5,      /*!<   5 [DeepSleep] GPIO Port Interrupt #5 */
  ioss_interrupts_gpio6_IRQn        =   6,      /*!<   6 [DeepSleep] GPIO Port Interrupt #6 */
  ioss_interrupts_gpio7_IRQn        =   7,      /*!<   7 [DeepSleep] GPIO Port Interrupt #7 */
  ioss_interrupts_gpio8_IRQn        =   8,      /*!<   8 [DeepSleep] GPIO Port Interrupt #8 */
  ioss_interrupts_gpio9_IRQn        =   9,      /*!<   9 [DeepSleep] GPIO Port Interrupt #9 */
  ioss_interrupts_gpio10_IRQn       =  10,      /*!<  10 [DeepSleep] GPIO Port Interrupt #10 */
  ioss_interrupts_gpio11_IRQn       =  11,      /*!<  11 [DeepSleep] GPIO Port Interrupt #11 */
  ioss_interrupts_gpio12_IRQn       =  12,      /*!<  12 [DeepSleep] GPIO Port Interrupt #12 */
  ioss_interrupts_gpio13_IRQn       =  13,      /*!<  13 [DeepSleep] GPIO Port Interrupt #13 */
  ioss_interrupts_gpio14_IRQn       =  14,      /*!<  14 [DeepSleep] GPIO Port Interrupt #14 */
  ...
  scb8_interrupt_IRQn               =  18,      /*!<  18 [DeepSleep] Serial Communication Block #8 (DeepSleep capable) */
  srss_interrupt_mcwdt0_IRQn        =  19,      /*!<  19 [DeepSleep] Multi Counter Watchdog Timer interrupt */
  srss_interrupt_mcwdt1_IRQn        =  20,      /*!<  20 [DeepSleep] Multi Counter Watchdog Timer interrupt */
  ...
  cpuss_interrupts_ipc0_IRQn        =  25,      /*!<  25 [DeepSleep] CPUSS Inter Process Communication Interrupt #0 */
  cpuss_interrupts_ipc1_IRQn        =  26,      /*!<  26 [DeepSleep] CPUSS Inter Process Communication Interrupt #1 */
  cpuss_interrupts_ipc2_IRQn        =  27,      /*!<  27 [DeepSleep] CPUSS Inter Process Communication Interrupt #2 */
  cpuss_interrupts_ipc3_IRQn        =  28,      /*!<  28 [DeepSleep] CPUSS Inter Process Communication Interrupt #3 */
  cpuss_interrupts_ipc4_IRQn        =  29,      /*!<  29 [DeepSleep] CPUSS Inter Process Communication Interrupt #4 */
  cpuss_interrupts_ipc5_IRQn        =  30,      /*!<  30 [DeepSleep] CPUSS Inter Process Communication Interrupt #5 */
  cpuss_interrupts_ipc6_IRQn        =  31,      /*!<  31 [DeepSleep] CPUSS Inter Process Communication Interrupt #6 */
  cpuss_interrupts_ipc7_IRQn        =  32,      /*!<  32 [DeepSleep] CPUSS Inter Process Communication Interrupt #7 */
  scb0_interrupt_IRQn               =  33,      /*!<  33 [Active] Serial Communication Block #0 */
  scb1_interrupt_IRQn               =  34,      /*!<  34 [Active] Serial Communication Block #1 */
  scb2_interrupt_IRQn               =  35,      /*!<  35 [Active] Serial Communication Block #2 */
  scb3_interrupt_IRQn               =  36,      /*!<  36 [Active] Serial Communication Block #3 */
  scb4_interrupt_IRQn               =  37,      /*!<  37 [Active] Serial Communication Block #4 */
  scb5_interrupt_IRQn               =  38,      /*!<  38 [Active] Serial Communication Block #5 */
  scb6_interrupt_IRQn               =  39,      /*!<  39 [Active] Serial Communication Block #6 */
  scb7_interrupt_IRQn               =  40,      /*!<  40 [Active] Serial Communication Block #7 */
  csd_interrupt_IRQn                =  41,      /*!<  41 [Active] CSD (Capsense) interrupt */
  cpuss_interrupts_dw00_IRQn        =  42,      /*!<  42 [Active] CPUSS DataWire #0, Channel #0 */
  cpuss_interrupts_dw01_IRQn        =  43,      /*!<  43 [Active] CPUSS DataWire #0, Channel #1 */
  cpuss_interrupts_dw02_IRQn        =  44,      /*!<  44 [Active] CPUSS DataWire #0, Channel #2 */
  cpuss_interrupts_dw03_IRQn        =  45,      /*!<  45 [Active] CPUSS DataWire #0, Channel #3 */
  cpuss_interrupts_dw04_IRQn        =  46,      /*!<  46 [Active] CPUSS DataWire #0, Channel #4 */
  cpuss_interrupts_dw05_IRQn        =  47,      /*!<  47 [Active] CPUSS DataWire #0, Channel #5 */
  cpuss_interrupts_dw06_IRQn        =  48,      /*!<  48 [Active] CPUSS DataWire #0, Channel #6 */
  cpuss_interrupts_dw07_IRQn        =  49,      /*!<  49 [Active] CPUSS DataWire #0, Channel #7 */
  cpuss_interrupts_dw08_IRQn        =  50,      /*!<  50 [Active] CPUSS DataWire #0, Channel #8 */
  cpuss_interrupts_dw09_IRQn        =  51,      /*!<  51 [Active] CPUSS DataWire #0, Channel #9 */
  cpuss_interrupts_dw010_IRQn       =  52,      /*!<  52 [Active] CPUSS DataWire #0, Channel #10 */
  cpuss_interrupts_dw011_IRQn       =  53,      /*!<  53 [Active] CPUSS DataWire #0, Channel #11 */
  cpuss_interrupts_dw012_IRQn       =  54,      /*!<  54 [Active] CPUSS DataWire #0, Channel #12 */
  cpuss_interrupts_dw013_IRQn       =  55,      /*!<  55 [Active] CPUSS DataWire #0, Channel #13 */
  cpuss_interrupts_dw014_IRQn       =  56,      /*!<  56 [Active] CPUSS DataWire #0, Channel #14 */
  cpuss_interrupts_dw015_IRQn       =  57,      /*!<  57 [Active] CPUSS DataWire #0, Channel #15 */
  cpuss_interrupts_dw10_IRQn        =  58,      /*!<  58 [Active] CPUSS DataWire #1, Channel #0 */
  cpuss_interrupts_dw11_IRQn        =  59,      /*!<  59 [Active] CPUSS DataWire #1, Channel #1 */
  cpuss_interrupts_dw12_IRQn        =  60,      /*!<  60 [Active] CPUSS DataWire #1, Channel #2 */
  cpuss_interrupts_dw13_IRQn        =  61,      /*!<  61 [Active] CPUSS DataWire #1, Channel #3 */
  cpuss_interrupts_dw14_IRQn        =  62,      /*!<  62 [Active] CPUSS DataWire #1, Channel #4 */
  cpuss_interrupts_dw15_IRQn        =  63,      /*!<  63 [Active] CPUSS DataWire #1, Channel #5 */
  cpuss_interrupts_dw16_IRQn        =  64,      /*!<  64 [Active] CPUSS DataWire #1, Channel #6 */
  cpuss_interrupts_dw17_IRQn        =  65,      /*!<  65 [Active] CPUSS DataWire #1, Channel #7 */
  cpuss_interrupts_dw18_IRQn        =  66,      /*!<  66 [Active] CPUSS DataWire #1, Channel #8 */
  cpuss_interrupts_dw19_IRQn        =  67,      /*!<  67 [Active] CPUSS DataWire #1, Channel #9 */
  cpuss_interrupts_dw110_IRQn       =  68,      /*!<  68 [Active] CPUSS DataWire #1, Channel #10 */
  cpuss_interrupts_dw111_IRQn       =  69,      /*!<  69 [Active] CPUSS DataWire #1, Channel #11 */
  cpuss_interrupts_dw112_IRQn       =  70,      /*!<  70 [Active] CPUSS DataWire #1, Channel #12 */
  cpuss_interrupts_dw113_IRQn       =  71,      /*!<  71 [Active] CPUSS DataWire #1, Channel #13 */
  cpuss_interrupts_dw114_IRQn       =  72,      /*!<  72 [Active] CPUSS DataWire #1, Channel #14 */
  cpuss_interrupts_dw115_IRQn       =  73,      /*!<  73 [Active] CPUSS DataWire #1, Channel #15 */
  cpuss_interrupts_fault0_IRQn      =  74,      /*!<  74 [Active] CPUSS Fault Structure Interrupt #0 */
  cpuss_interrupts_fault1_IRQn      =  75,      /*!<  75 [Active] CPUSS Fault Structure Interrupt #1 */
  cpuss_interrupt_crypto_IRQn       =  76,      /*!<  76 [Active] CRYPTO Accelerator Interrupt */
  cpuss_interrupt_fm_IRQn           =  77,      /*!<  77 [Active] FLASH Macro Interrupt */
  cpuss_interrupts_cm0_cti0_IRQn    =  78,      /*!<  78 [Active] CM0+ CTI #0 */
  cpuss_interrupts_cm0_cti1_IRQn    =  79,      /*!<  79 [Active] CM0+ CTI #1 */
  cpuss_interrupts_cm4_cti0_IRQn    =  80,      /*!<  80 [Active] CM4 CTI #0 */
  cpuss_interrupts_cm4_cti1_IRQn    =  81,      /*!<  81 [Active] CM4 CTI #1 */
  tcpwm0_interrupts0_IRQn           =  82,      /*!<  82 [Active] TCPWM #0, Counter #0 */
  tcpwm0_interrupts1_IRQn           =  83,      /*!<  83 [Active] TCPWM #0, Counter #1 */
  tcpwm0_interrupts2_IRQn           =  84,      /*!<  84 [Active] TCPWM #0, Counter #2 */
  tcpwm0_interrupts3_IRQn           =  85,      /*!<  85 [Active] TCPWM #0, Counter #3 */
  tcpwm0_interrupts4_IRQn           =  86,      /*!<  86 [Active] TCPWM #0, Counter #4 */
  tcpwm0_interrupts5_IRQn           =  87,      /*!<  87 [Active] TCPWM #0, Counter #5 */
  tcpwm0_interrupts6_IRQn           =  88,      /*!<  88 [Active] TCPWM #0, Counter #6 */
  tcpwm0_interrupts7_IRQn           =  89,      /*!<  89 [Active] TCPWM #0, Counter #7 */
  tcpwm1_interrupts0_IRQn           =  90,      /*!<  90 [Active] TCPWM #1, Counter #0 */
  tcpwm1_interrupts1_IRQn           =  91,      /*!<  91 [Active] TCPWM #1, Counter #1 */
  tcpwm1_interrupts2_IRQn           =  92,      /*!<  92 [Active] TCPWM #1, Counter #2 */
  tcpwm1_interrupts3_IRQn           =  93,      /*!<  93 [Active] TCPWM #1, Counter #3 */
  tcpwm1_interrupts4_IRQn           =  94,      /*!<  94 [Active] TCPWM #1, Counter #4 */
  tcpwm1_interrupts5_IRQn           =  95,      /*!<  95 [Active] TCPWM #1, Counter #5 */
  tcpwm1_interrupts6_IRQn           =  96,      /*!<  96 [Active] TCPWM #1, Counter #6 */
  tcpwm1_interrupts7_IRQn           =  97,      /*!<  97 [Active] TCPWM #1, Counter #7 */
  tcpwm1_interrupts8_IRQn           =  98,      /*!<  98 [Active] TCPWM #1, Counter #8 */
  tcpwm1_interrupts9_IRQn           =  99,      /*!<  99 [Active] TCPWM #1, Counter #9 */
  tcpwm1_interrupts10_IRQn          = 100,      /*!< 100 [Active] TCPWM #1, Counter #10 */
  tcpwm1_interrupts11_IRQn          = 101,      /*!< 101 [Active] TCPWM #1, Counter #11 */
  tcpwm1_interrupts12_IRQn          = 102,      /*!< 102 [Active] TCPWM #1, Counter #12 */
  tcpwm1_interrupts13_IRQn          = 103,      /*!< 103 [Active] TCPWM #1, Counter #13 */
  tcpwm1_interrupts14_IRQn          = 104,      /*!< 104 [Active] TCPWM #1, Counter #14 */
  tcpwm1_interrupts15_IRQn          = 105,      /*!< 105 [Active] TCPWM #1, Counter #15 */
  tcpwm1_interrupts16_IRQn          = 106,      /*!< 106 [Active] TCPWM #1, Counter #16 */
  tcpwm1_interrupts17_IRQn          = 107,      /*!< 107 [Active] TCPWM #1, Counter #17 */
  tcpwm1_interrupts18_IRQn          = 108,      /*!< 108 [Active] TCPWM #1, Counter #18 */
  tcpwm1_interrupts19_IRQn          = 109,      /*!< 109 [Active] TCPWM #1, Counter #19 */
  tcpwm1_interrupts20_IRQn          = 110,      /*!< 110 [Active] TCPWM #1, Counter #20 */
  tcpwm1_interrupts21_IRQn          = 111,      /*!< 111 [Active] TCPWM #1, Counter #21 */
  tcpwm1_interrupts22_IRQn          = 112,      /*!< 112 [Active] TCPWM #1, Counter #22 */
  tcpwm1_interrupts23_IRQn          = 113,      /*!< 113 [Active] TCPWM #1, Counter #23 */
  udb_interrupts0_IRQn              = 114,      /*!< 114 [Active] UDB Interrupt #0 */
  udb_interrupts1_IRQn              = 115,      /*!< 115 [Active] UDB Interrupt #1 */
  udb_interrupts2_IRQn              = 116,      /*!< 116 [Active] UDB Interrupt #2 */
  udb_interrupts3_IRQn              = 117,      /*!< 117 [Active] UDB Interrupt #3 */
  udb_interrupts4_IRQn              = 118,      /*!< 118 [Active] UDB Interrupt #4 */
  udb_interrupts5_IRQn              = 119,      /*!< 119 [Active] UDB Interrupt #5 */
  udb_interrupts6_IRQn              = 120,      /*!< 120 [Active] UDB Interrupt #6 */
  udb_interrupts7_IRQn              = 121,      /*!< 121 [Active] UDB Interrupt #7 */
  udb_interrupts8_IRQn              = 122,      /*!< 122 [Active] UDB Interrupt #8 */
  udb_interrupts9_IRQn              = 123,      /*!< 123 [Active] UDB Interrupt #9 */
  udb_interrupts10_IRQn             = 124,      /*!< 124 [Active] UDB Interrupt #10 */
  udb_interrupts11_IRQn             = 125,      /*!< 125 [Active] UDB Interrupt #11 */
  udb_interrupts12_IRQn             = 126,      /*!< 126 [Active] UDB Interrupt #12 */
  udb_interrupts13_IRQn             = 127,      /*!< 127 [Active] UDB Interrupt #13 */
  udb_interrupts14_IRQn             = 128,      /*!< 128 [Active] UDB Interrupt #14 */
  udb_interrupts15_IRQn             = 129,      /*!< 129 [Active] UDB Interrupt #15 */
  pass_interrupt_sar_IRQn           = 130,      /*!< 130 [Active] SAR ADC interrupt */
  audioss_interrupt_i2s_IRQn        = 131,      /*!< 131 [Active] I2S Audio interrupt */
  audioss_interrupt_pdm_IRQn        = 132,      /*!< 132 [Active] PDM/PCM Audio interrupt */
  profile_interrupt_IRQn            = 133,      /*!< 133 [Active] Energy Profiler interrupt */
  smif_interrupt_IRQn               = 134,      /*!< 134 [Active] Serial Memory Interface interrupt */
  usb_interrupt_hi_IRQn             = 135,      /*!< 135 [Active] USB Interrupt */
  usb_interrupt_med_IRQn            = 136,      /*!< 136 [Active] USB Interrupt */
  usb_interrupt_lo_IRQn             = 137,      /*!< 137 [Active] USB Interrupt */
  pass_interrupt_dacs_IRQn          = 138,      /*!< 138 [Active] Consolidated interrrupt for all DACs */
  unconnected_IRQn                  = 240       /*!< 240 Unconnected */
#endif
} IRQn_Type;
