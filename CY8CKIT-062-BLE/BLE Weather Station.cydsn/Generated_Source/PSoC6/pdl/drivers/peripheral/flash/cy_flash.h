...
*     <td>Variable actually is modified by the ROM code</td>
*   </tr>
*   <tr>
*     <td>14.1</td>
*     <td>R</td>
...
#define CY_FLASH_IPC_INT_MASK              (0x07UL)
/** \endcond */
...
#define CY_FLASH_OPCODE_WRITE_ROW          (((0x05UL) << 24UL) | ((0x01UL) << 8UL))
/** SROM API opcode for row erase operation */
#define CY_FLASH_OPCODE_ERASE_ROW          (((0x1CUL) << 24UL) | ((0x01UL) << 8UL))
