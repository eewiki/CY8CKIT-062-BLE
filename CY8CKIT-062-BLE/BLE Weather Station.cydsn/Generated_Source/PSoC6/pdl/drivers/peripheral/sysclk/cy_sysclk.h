...
*
* \warning When the device is in the Ultra-Low Power (ULP) mode, the maximum frequency
*    of some clocks is reduced. See the device datasheet for details.
*
...
*     <td>14.3</td>
*     <td>R</td>
*     <td>Before preprocessing, a null statement only occurs on a line by itself; it may be followed by a comment
*         if the first character following the null statement is a white-space character.</td>
*     <td> The null statement is located close to other code or comments.</td>
*   </tr>
*   <tr>
*     <td>14.8</td>
*     <td>R</td>
*     <td>The statement forming the body of a switch, while, do ... while or for statement shall be a compound
*         statement.</td>
*     <td>The body of the control statement is on the same line and is not enclosed within braces.</td>
*   </tr>
*   <tr>
*     <td>14.9</td>
*     <td>R</td>
*     <td>An if (expression) construct is followed by a compound statement. The else keyword shall be followed by
*         either a compound statement, or another if statement.</td>
*     <td>The body of the control statement is on the same line and is not enclosed within braces.</td>
*   </tr>
*   <tr>
*     <td>16.7</td>
...
*     <td>19.7</td>
*     <td>A</td>
*     <td>A function is used in preference to a function-like macro.</td>
...
*   They are typically called in the following order:<br>
*   <br>
*   1. Specify the measured clock and reference clock, and start the measurement counters:<br>
*   \ref Cy_SysClk_StartClkMeasurementCounters();<br>
*   2. Wait for the measurement counter to finish counting:<br>
*   while(\ref Cy_SysClk_ClkMeasurementCountersDone() != CY_RET_FINISHED);<br>
*   3. When counting is done, read counter 2, do the calculations, and report the measured frequency:<br>
*   freq_measur = \ref Cy_SysClk_ClkMeasurementCountersGetFreq();<br>
*   <br>
*   \note These functions may also be used as part of a clock trimming process - see the Clock Trim section.
...
* \{
*   These functions do a single trim operation on a specified clock.
*   Each function's parameter is the actual frequency of the specified clock.
*   To measure the frequency of a clock, see the Clock Measurement section.<br>
*   <br>
*   To trim the clock as close as possible to the target frequency, multiple calls to the trim function may be needed.
*   A typical usage example is to:<br>
*   1. Call the clock measurement functions to get the actual frequency of the clock.<br>
*   2. Call the trim function, passing in the measured frequency.<br>
*   3. Repeat the above until the trim function reports trimming is done.<br>
...
* \}
* \defgroup group_sysclk_clk_peri        Peripheral Clock Divider Control
* \{
                                                        ...
                                                        cy_en_divider_types_t dividerTypePA, uint32_t dividerNumPA)
{
    ...
    if (dividerTypePA <= CY_SYSCLK_DIV_24_5_BIT)
    {
        if (((dividerTypePA == CY_SYSCLK_DIV_8_BIT)    && (dividerNumPA < PERI_DIV_8_NR))    ||
            ...
            ((dividerTypePA == CY_SYSCLK_DIV_24_5_BIT) && (dividerNumPA < PERI_DIV_24_5_NR)))
        {
