...
typedef struct stc_scb_uart_config
{
    ...
    * (See \ref group_scb_uart_macros_modes for the set of constants)
    */
    uint32_t    uartMode;
    ...
    * increments (See \ref group_scb_uart_macros_stop_bits for the set of
    * constants.)
    */
    uint32_t    stopBits;
    ...
    * (See \ref group_scb_uart_macros_parity for the set of constants.)
    */
    uint32_t    parity;
    ...
    * (See \ref group_scb_uart_macros_polarity for the set of constants.)
    */
...
cy_en_scb_uart_status_t Cy_SCB_UART_Receive(CySCB_Type *base, void *rxBuf, uint32_t size,
                                            cy_stc_scb_uart_context_t *context);
...
cy_en_scb_uart_status_t Cy_SCB_UART_Transmit(CySCB_Type *base, void *txBuf, uint32_t size,
                                             cy_stc_scb_uart_context_t *context);
...
/**
* \defgroup group_scb_uart_macros_modes UART Mode Defines
* \{
*/
...
/** \} group_scb_uart_macros_modes */

/**
* \defgroup group_scb_uart_macros_stop_bits UART Stop Bit Defines
* \{
*/
...
/** \} group_scb_uart_macros_stop_bits */

/**
* \defgroup group_scb_uart_macros_parity UART Parity Defines
* \{
*/
