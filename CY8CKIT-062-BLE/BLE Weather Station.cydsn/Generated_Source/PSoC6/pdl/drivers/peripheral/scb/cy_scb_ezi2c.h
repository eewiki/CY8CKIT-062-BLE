...
typedef struct cy_stc_scb_ezi2c_config
{
    ...
    * \ref group_scb_ezi2c_macros_num_of_addr for the set of constants)
    */
    ...
    * \ref group_scb_ezi2c_macros_sub_addr_size for the set of constants)
    */
...
/**
* \defgroup group_scb_ezi2c_macros_num_of_addr Number of Addresses
* \{
*/
#define CY_SCB_EZI2C_ONE_ADDRESS    (0UL)   /**< Only one address */
#define CY_SCB_EZI2C_TWO_ADDRESSES  (1UL)   /**< Two addresses */
/** \} group_scb_ezi2c_macros_num_of_addr */

/**
* \defgroup group_scb_ezi2c_macros_sub_addr_size Size of Sub-Address
* \{
*/
...
/** \} group_scb_ezi2c_macros_sub_addr_size */
