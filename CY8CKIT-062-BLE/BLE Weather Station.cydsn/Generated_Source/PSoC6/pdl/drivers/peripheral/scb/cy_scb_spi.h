...
typedef struct cy_stc_scb_spi_config
{
    ...
    * (See \ref group_scb_spi_macros_modes for the set of constants)
    */
    uint32_t    spiMode;

    /**
    * Specifies the submode of SPI operation
    * (See \ref group_scb_spi_macros_sub_modes for the set of constants)
    */
    uint32_t    subMode;

    /**
    * Configures the SCLK operation for Motorola sub-mode, ignored for all
    * other submodes (See \ref group_scb_spi_macros_sclk_modes for the set
    * of constants)
    */
    uint32_t    sclkMode;
...
/**
* \defgroup group_scb_spi_macros_modes SPI Modes
* \{
*/
...
/** \} group_scb_spi_macros_modes */

/**
* \defgroup group_scb_spi_macros_sub_modes SPI Submodes
* \{
*/
...
/** \} group_scb_spi_macros_sub_modes */

/**
* \defgroup group_scb_spi_macros_sclk_modes SPI SCLK Modes
* \{
*/
...
/** \} group_scb_spi_macros_sclk_modes */

/**
* \defgroup group_scb_spi_macros_slave_select SPI Slave Selects
* \{
*/
...
/** \} group_scb_spi_macros_slave_select */

/**
* \defgroup group_scb_spi_macros_polarity SPI Polarity
* \{
*/
...
* See \ref group_scb_spi_macros_slave_select for the set of constants.
*
* \note
...
* See \ref group_scb_spi_macros_polarity for the set of constants.
*
* \note
* The SCB be idle or disabled before calling this function.
*
