...
* See \ref group_scb_i2c_macros_ack_nack for the set of constants.
...
{
    /**
    * Specifies the mode of operation (See \ref group_scb_i2c_macros_modes
...
* \{
*/
cy_en_scb_i2c_status_t Cy_SCB_I2C_MasterSendStart  (CySCB_Type *base, uint32_t address, uint32_t bitRnW,
                                                    uint32_t timeoutMs, cy_stc_scb_i2c_context_t *context);
cy_en_scb_i2c_status_t Cy_SCB_I2C_MasterSendReStart(CySCB_Type *base, uint32_t address, uint32_t bitRnW,
                                                    uint32_t timeoutMs, cy_stc_scb_i2c_context_t *context);
cy_en_scb_i2c_status_t Cy_SCB_I2C_MasterSendStop   (CySCB_Type *base,uint32_t timeoutMs,
                                                    cy_stc_scb_i2c_context_t *context);
cy_en_scb_i2c_status_t Cy_SCB_I2C_MasterReadByte   (CySCB_Type *base, uint32_t ackNack, uint8_t *byte,
                                                    uint32_t timeoutMs, cy_stc_scb_i2c_context_t *context);
cy_en_scb_i2c_status_t Cy_SCB_I2C_MasterWriteByte  (CySCB_Type *base, uint8_t theByte, uint32_t timeoutMs,
                                                    cy_stc_scb_i2c_context_t *context);
...
/**
* \defgroup group_scb_i2c_macros_modes I2C Modes
* \{
*/
...
/** \} group_scb_i2c_macros_modes */

/**
* \defgroup group_scb_i2c_macros_direction I2C Direction
* \{
*/
#define CY_SCB_I2C_WRITE_XFER  (0UL)   /**< Current transaction is Write */
#define CY_SCB_I2C_READ_XFER   (1UL)   /**< Current transaction is Read */
/** \} group_scb_i2c_macros_direction */

/**
* \defgroup group_scb_i2c_macros_ack_nack I2C ACK NAK
* \{
*/
