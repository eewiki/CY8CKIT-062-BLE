...
typedef struct
{
    ...
    /** Specifies the notify interrupt number for the third endpoint */
    /* cy_stc_ipc_pipe_ep_config_t ep2Config;  - Add new Endpoint configuration HERE */
...
/** \cond INTERNAL */
/** Backward compatibility define for the Cy_IPC_Pipe_EndpointPause() API.
*   Do not use it in your code.
*/
#define Cy_IPC_Pipe_Pause(epAddr, clientId)          Cy_IPC_Pipe_EndpointPause(epAddr)
/** Backward compatibility define for the Cy_IPC_Pipe_EndpointResume() API.
*   Do not use it in your code.
*/
#define Cy_IPC_Pipe_Continue(epAddr, clientId)       Cy_IPC_Pipe_EndpointResume(epAddr)
/** \endcond */
