...
#define CY_BLE_STACK_BUILD                                               (695u)

/** BT Address Size */
#define CY_BLE_BD_ADDR_SIZE                                              (0x06u)

/** BLE Middleware ID */
#define CY_BLE_ID                                                        (0x05u << 18u)
...
#define CY_BLE_FEATURE_BIT_MASK                                          (0x007Fu)
...
typedef enum
{
    ...
    CY_BLE_ERROR_INVALID_PARAMETER = CY_PDL_STATUS_ERROR | CY_BLE_ID | 0x0001u,
   ...
   /** Controller error codes. These come directly from the controller (not the host stack)*/
    ...
    /** Controller Busy */
    CY_BLE_ERROR_CONTROLLER_BUSY = CY_PDL_STATUS_ERROR | CY_BLE_ID | 0x00FEu,
    ...
    CY_BLE_ERROR_MAX = CY_PDL_STATUS_ERROR | CY_BLE_ID | 0xFFFFu,
...
typedef struct
{
     ...
     * B4 : PHY_UPDATE_FEATURE_MASK
     * B5 : PERSISTENT_STORE_BONDLIST
     * B6 : PERSISTENT_STORE_RESOLVING_LIST
     * B7 : PERSISTENT_STORE_WHITELIST
     */
...
* 
******************************************************************************/
cy_en_ble_api_result_t Cy_BLE_IsControllerActive(void);
