...
typedef struct
{
    ...
    /** CCCD values */
    uint8_t attValuesCCCDFlashMemory[CY_BLE_MAX_BONDED_DEVICES + CY_BLE_CONN_COUNT][CY_BLE_GATT_DB_FLASH_CCCD_COUNT];
...
#if (CY_BLE_GATT_ROLE_SERVER)
#if (CY_BLE_GATT_DB_CCCD_COUNT != 0u)
extern uint8_t cy_ble_attValuesCccdMultiple[CY_BLE_CONN_COUNT][CY_BLE_GATT_DB_CCCD_COUNT];
#endif /* CY_BLE_GATT_DB_CCCD_COUNT != 0u */
#endif /* (CY_BLE_GATT_ROLE_SERVER) */
...
/** @} group_common_api_gatt_functions */
