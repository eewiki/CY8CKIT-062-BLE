...
typedef enum
{
    CY_BLE_HIDS_PROTOCOL_MODE,                             /**< Protocol Mode Characteristic index */
    CY_BLE_HIDS_INFORMATION,                               /**< HID Information Characteristic index */
    CY_BLE_HIDS_CONTROL_POINT,                             /**< HID Control Point Characteristic index */
    CY_BLE_HIDS_REPORT_MAP,                                /**< Report Map Characteristic index */
    CY_BLE_HIDS_BOOT_KYBRD_IN_REP,                         /**< Boot Keyboard Input Report Characteristic index */
    CY_BLE_HIDS_BOOT_KYBRD_OUT_REP,                        /**< Boot Keyboard Output Report Characteristic index */
    CY_BLE_HIDS_BOOT_MOUSE_IN_REP,                         /**< Boot Mouse Input Report Characteristic index */
    CY_BLE_HIDS_REPORT,                                    /**< Report Characteristic index */
    CY_BLE_HIDS_REPORT_END =                               /**< Index of last Report Char */
                             CY_BLE_HIDS_REPORT + CY_BLE_HIDS_REPORT_COUNT - 1,
    CY_BLE_HIDS_CHAR_COUNT                                 /**< Total count of characteristics */
