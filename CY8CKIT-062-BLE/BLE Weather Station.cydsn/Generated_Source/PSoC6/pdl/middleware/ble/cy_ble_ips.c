...
* 
*  NOTE: when advertisement is active this API uses Cy_BLE_GAP_UpdateAdvScanData() to 
...
static cy_en_ble_api_result_t Cy_BLE_IPSS_SetAdvertisementData(void)
{
    ...
    {
        apiResult = Cy_BLE_GAP_UpdateAdvScanData(&cy_ble_configPtr->discoveryModeInfo[cy_ble_advIndex]);
    }
