...
#define CY_BLE_M0S8BLESS_VERSION             (3u)
...
#define CY_BLE_CONN_COUNT                    (CY_BLE_MAX_CONNECTION_INSTANCES)
...
#define CY_BLE_STACK_FLASH_SIZE    (CY_BLE_STACK_BOND_FLASH_SIZE + \
                                    CY_BLE_STACK_RESOLVING_LIST_SIZE + CY_BLE_STACK_WHITELIST_SIZE)

/** @} group_common_api_definitions */
