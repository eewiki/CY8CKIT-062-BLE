...
/**
 \addtogroup cy_ble_stack_host_main_h
 @{
*/
...
#define CY_BLE_DEFAULT_HOST_RAM_SIZE             (16u + 1024u + 824u + 120u + 256u + 64u)
 ...
 * Memory = CY_BLE_L2CAP_QUEUE_ELEMENT_SIZE * CY_BLE_L2CAP_MIN_STACK_Q_DEPTH_PER_CONN * 4;
 */ 
 ...
 */
#define CY_BLE_RAM_SIZE_SECURE_SINGLE_CONN        (0x3ACu) /**< SC single connection */
/** SC multiconnection */
 ...
 * #define CY_BLE_STACK_FLASH_STORAGE_SIZE 
    * Bonded device list memory computation
    * CY_BLE_STACK_BONDED_DEVICE_SIZE = ((CY_BLE_STACK_ONE_BONDED_DEVICE_SIZE * User configured bondlist size)
