...
cy_stc_ble_gapp_disc_data_t cy_ble_discoveryData[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        { 0x02u, 0x01u, 0x06u, 0x0Eu, 0x09u, 0x50u, 0x53u,
        0x6Fu, 0x43u, 0x36u, 0x20u, 0x57u, 0x65u, 0x61u,
        0x74u, 0x68u, 0x65u, 0x72u, 0x00u, 0x00u, 0x00u,
...
static uint8_t cy_ble_attValues[0x21u] = {
    /* Device Name */
    (uint8_t)'P', (uint8_t)'S', (uint8_t)'o', (uint8_t)'C', (uint8_t)'6', (uint8_t)' ', (uint8_t)'W', (uint8_t)'e',
(uint8_t)'a', (uint8_t)'t', (uint8_t)'h', (uint8_t)'e', (uint8_t)'r', 
...
static const uint8_t cy_ble_attUuid128[][16u] = {
    /* Weather Station */
    { 0xF8u, 0xC4u, 0x6Du, 0xE7u, 0x0Bu, 0xAEu, 0x00u, 0xB1u, 0x15u, 0x40u, 0xE3u, 0x02u, 0xC8u, 0xF2u, 0x76u, 0xF4u },
};
...
static cy_stc_ble_gatts_att_gen_val_len_t cy_ble_attValuesLen[0x0Cu] = {
    ...
    { 0x0001u, (void *)&cy_ble_attValues[23] }, /* Central Address Resolution */
    { 0x0001u, (void *)&cy_ble_attValues[24] }, /* Resolvable Private Address Only */
    { 0x0004u, (void *)&cy_ble_attValues[25] }, /* Service Changed */
    { 0x0002u, (void *)&cy_ble_attValuesCCCD[0] }, /* Client Characteristic Configuration */
    { 0x0010u, (void *)&cy_ble_attUuid128[0] }, /* Weather Station UUID */
    { 0x0002u, (void *)&cy_ble_attValues[29] }, /* Temperature */
    { 0x0002u, (void *)&cy_ble_attValuesCCCD[2] }, /* Client Characteristic Configuration */
    { 0x0002u, (void *)&cy_ble_attValues[31] }, /* Humidity */
...
static const cy_stc_ble_gatts_db_t cy_ble_gattDB[0x16u] = {
    ...
    { 0x0011u, 0x2803u /* Characteristic                      */, 0x00120001u /* rd,ntf */, 0x0013u, {{0x2A6Eu, NULL}}                           },
    { 0x0012u, 0x2A6Eu /* Temperature                         */, 0x01120001u /* rd,ntf */, 0x0013u, {{0x0002u, (void *)&cy_ble_attValuesLen[8]}} },
    { 0x0013u, 0x2902u /* Client Characteristic Configuration */, 0x030A0101u /* rd,wr  */, 0x0013u, {{0x0002u, (void *)&cy_ble_attValuesLen[9]}} },
    { 0x0014u, 0x2803u /* Characteristic                      */, 0x00120001u /* rd,ntf */, 0x0016u, {{0x2A6Fu, NULL}}                           },
    { 0x0015u, 0x2A6Fu /* Humidity                            */, 0x01120001u /* rd,ntf */, 0x0016u, {{0x0002u, (void *)&cy_ble_attValuesLen[10]}} },
    { 0x0016u, 0x2902u /* Client Characteristic Configuration */, 0x030A0101u /* rd,wr  */, 0x0016u, {{0x0002u, (void *)&cy_ble_attValuesLen[11]}} },
};
