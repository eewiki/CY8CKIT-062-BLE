...
#define CY_IPC_CHAN_SYSCALL_DAP         (uint32_t)(2u)  /* System call */
#define CY_IPC_CHAN_CRYPTO              (uint32_t)(3u)
#define CY_IPC_CHAN_SEMA                (uint32_t)(4u)

#define CY_IPC_CHAN_CYPIPE_EP0          (uint32_t)(5u)    /* IPC data channel for EP0 */
#define CY_IPC_CHAN_CYPIPE_EP1          (uint32_t)(6u)    /* IPC data channel for EP1 */
...
#define CY_IPC_INTR_SYSCALL2            (uint32_t)(1u)
#define CY_IPC_INTR_SYSCALL3            (uint32_t)(2u)

#define CY_IPC_INTR_CRYPTO_SRV          (uint32_t)(3u)
#define CY_IPC_INTR_CRYPTO_CLI          (uint32_t)(4u)
...
#define CY_IPC_INTR_CYPIPE_MUX_EP0      (uint32_t)(28u)  /* IPC CYPRESS PIPE */
#define CY_IPC_INTR_CYPIPE_EP0          (uint32_t)(5u)   /* Notifier EP0 */
#define CY_IPC_INTR_CYPIPE_PRIOR_EP0    (uint32_t)(1u)   /* Notifier Priority */
#define CY_IPC_INTR_CYPIPE_EP1          (uint32_t)(6u)   /* Notifier EP1 */
...
/******************************************************************************/
#define CY_IPC_INTR_USRPIPE_CM0          (uint32_t)(8u)  /* Invalid Interrupt */
#define CY_IPC_INTR_USRPIPE_CM4          (uint32_t)(9u)  /* Invalid Interrupt */
